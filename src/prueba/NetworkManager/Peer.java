...
public class Peer {
    ...
    public void connect(PeerListener listener) {
        System.out.println("Attempting to connect peer:" + id + " to " + host.getHostAddress() + ":" + port);
        try {
    ...
    private String handshake() throws IOException {
        ...
        if (responseType != GameMessage.HANDSHAKE) {
        ...
        System.out.println("Received username: " + peerUsername);
